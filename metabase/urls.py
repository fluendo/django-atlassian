...
urlpatterns = [
    ...
    url(r'^confluence-configuration/$', views.ConfluenceConfiguration.as_view(), name='metabase-confluence-configuration-page'),
    url(r'^macro-view/$', views.macro_view, name='metabase-macro-view'),
    url(r'^macro-configuration/$', views.macro_configuration, name='metabase-macro-configuration'),
]
